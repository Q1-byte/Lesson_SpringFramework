    ...
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <body>
        ...
        <div class="container mt-3">
          <h2>Member Read</h2>
          <form id="form" action="/member/read" method="post">
            ...
            <div class="mb-3 mt-3">
              <label>Name:</label>
              <input type="text" class="form-control" name="name" value="<c:out value='${member.name}'/>" readonly>
            </div>
            <div class="mb-3 mt-3">
              <label>Email:</label>
              <input type="email" class="form-control" name="email" value="<c:out value='${member.email}'/>" readonly>
            </div>
            <div class="mb-3">
              <label>Password:</label>
              <input type="password" class="form-control" name="password" value="<c:out value='${member.password}'/>"
                readonly>
            </div>
